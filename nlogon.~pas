...
uses
  ...
  Dialogs, StdCtrls, XMLINI, jpeg, ExtCtrls,ShellAPI, XPMan;
...
procedure Tlogon.Info(Sender: TObject);
begin
MessageBox(HANDLE,PAnsiChar('n!logon v0.2 - (c) 2005 Micha³ Zubkowicz. Strona programu: http://www.nlogon.one.pl'),'Informacje o programie',MB_ICONASTERISK);
end;
